...
public class TemplateController {
    ...
    @Operation(summary = "Retrieve engine list", description = "This API is used for retrieving engine list.")
    @ApiResponses({
    ...
    @Operation(summary = "Retrieve supported content type list", description = "This API is used for retrieving supported content type for a template engine.")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Request executed with success"),
            @ApiResponse(responseCode = "401", description = "Request not authorized"),
            @ApiResponse(responseCode = "500", description = "Error encountered when executing request")
    ...
    public ResponseEntity<Set<String>> getContentTypes(
            @Parameter(description = "The engine identifier", required = true) @PathVariable(name = "engine-identifier", required = true) String engineIdentifier
    ) {
    ...
    @Operation(summary = "Retrieve supported result mime type list for a specified content type", description = "This API is used for retrieving supported result mime type list for a template engine content type.")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Request executed with success"),
            @ApiResponse(responseCode = "401", description = "Request not authorized"),
            @ApiResponse(responseCode = "500", description = "Error encountered when executing request")
    ...
    public ResponseEntity<Set<String>> getModes(
            @Parameter(description = "The engine identifier", required = true) @PathVariable(name = "engine-identifier", required = true) String engineIdentifier,
            @Parameter(description = "The content type identifier", required = true) @PathVariable(name = "content-type-identifier", required = true) String contentTypeIdentifier
    ) {
    ...
    //CREATE TEMPLATE
    @Operation(summary = "Create template", description = "This API is used for creating a new template entry.")
    @ApiResponses({
    ...
    public ResponseEntity<Template> createTemplate(
            @Parameter(description = "The template", required = true) @Valid @RequestBody Template template) {
    ...
    //GET TEMPLATE
    @Operation(summary = "Retrieve template", description = "This API is used for retrieving template.")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Request executed with success"),
            @ApiResponse(responseCode = "401", description = "Request not authorized"),
            @ApiResponse(responseCode = "500", description = "Error encountered when executing request")
    ...
    public ResponseEntity<Template> retrieveTemplate(
            @Parameter(description = "The identifier used to identify a template.", required = true) @PathVariable(value = "identifier", required = true) String identifier
    ) {
    ...
    //LIST TEMPLATE
    @Operation(summary = "Retrieve template list", description = "This API is used for retrieving template lists.")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Request executed with success"),
            @ApiResponse(responseCode = "401", description = "Request not authorized"),
            @ApiResponse(responseCode = "500", description = "Error encountered when executing request")
    ...
    public ResponseEntity<Page<Template>> listTemplate(
            @Parameter(description = "The engine", required = true) @Valid @RequestParam(name = "engine", required = true) List<String> engineList,
            @Parameter(description = "The namespace") @Valid @RequestParam(name = "namespace", required = false) String namespace,
            @Parameter(description = "The name") @Valid @RequestParam(name = "name", required = false) String name,
            @Parameter(description = "The operator") @Valid @RequestParam(name = "operator", required = false) TemplateSearchOperator operator,
    ...
    //UPDATE BY ID
    @Operation(summary = "Update template info", description = "This API is used for updating a template.")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Request executed with success"),
            @ApiResponse(responseCode = "401", description = "Request not authorized"),
    ...
    public ResponseEntity<Void> updateTemplate(
            @Parameter(description = "The identifier used to identify a template.", required = true) @PathVariable(value = "identifier", required = true) Long identifier,
            @Parameter(description = "The template details", required = true) @Valid @RequestBody Template template
    ) {
    ...
    //DELETE BY ID
    @Operation(summary = "Delete template info", description = "This API is used for deleting a template.")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Request executed with success"),
            @ApiResponse(responseCode = "401", description = "Request not authorized"),
            @ApiResponse(responseCode = "404", description = "Process does not exists"),
